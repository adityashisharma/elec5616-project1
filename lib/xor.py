"""
lib/xor.py — DEPRECATED

⚠️ This XOR cipher is insecure and was only used in the original scaffold.
✅ It has been fully replaced with AES-CBC and HMAC in lib/comms.py as per marking scheme.
"""
